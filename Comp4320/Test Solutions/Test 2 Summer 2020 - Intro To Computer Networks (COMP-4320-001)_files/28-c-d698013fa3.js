(window["canvasWebpackJsonp"]=window["canvasWebpackJsonp"]||[]).push([[28],{"97gy":function(e,n,t){"use strict"
...
var f=function(e){Object(i["a"])(t,e)
var n=Object(d["a"])(t)
function t(){Object(r["a"])(this,t)
return n.apply(this,arguments)}Object(a["a"])(t,[{key:"render",value:function(){return s.a.createElement(l["a"],Object.assign({},this.props,{name:"IconCheckMark",viewBox:"0 0 1920 1920"}),u)}}])
t.displayName="IconCheckMarkSolid"
return t}(c["Component"])
f.glyphName="check-mark"
f.variant="Solid"
f.propTypes=Object(o["a"])({},l["a"].propTypes)},Dibh:function(e,n,t){"use strict"
var o=t("Ff2n")
var r=t("rePB")
var a=t("1OyB")
var i=t("vuIU")
...
var T=(B=Object(U["a"])(),C=Object(G["j"])(M,L),B(D=C(D=(R=N=function(e){Object(d["a"])(t,e)
var n=Object(c["a"])(t)
...
var d=false
l.a.Children.forEach(t,(function(e){e&&Object(g["a"])(e,[E["a"]])&&(d=true)}))
var c=(e={},Object(r["a"])(e,L.root,true),Object(r["a"])(e,L.inverse,"inverse"===a),Object(r["a"])(e,L.withCloseButton,true===d),e)
return l.a.createElement("div",Object.assign({className:b()(c)},Object(x["b"])(i)),t)}}])
t.displayName="ModalHeader"
return t}(s["Component"]),N.propTypes={children:f.a.node,variant:f.a.oneOf(["default","inverse"])},N.defaultProps={children:null,variant:"default"},R))||D)||D)
t("DEX3")
var S=t("n12J")
...
var J=(q=Object(U["a"])(),I=Object(G["j"])(F,X),q(W=I(W=(P=z=function(e){Object(d["a"])(t,e)
var n=Object(c["a"])(t)
function t(){Object(a["a"])(this,t)
return n.apply(this,arguments)}Object(i["a"])(t,[{key:"render",value:function(){var e
var n=this.props,a=n.as,i=n.elementRef,d=n.overflow,c=n.variant,s=n.padding,u=n.children,f=Object(o["a"])(n,["as","elementRef","overflow","variant","padding","children"])
var p=S["a"].omitViewProps(f,t)
var v=b()((e={},Object(r["a"])(e,X.root,true),Object(r["a"])(e,X.inverse,"inverse"===c),e))
var h="fit"===d
j["a"]
return l.a.createElement(S["a"],Object.assign({},p,{display:"block",width:h?"100%":null,height:h?"100%":null,elementRef:i,as:a,className:v,padding:s,tabIndex:"-1"}),u)}}])
t.displayName="ModalBody"
return t}(s["Component"]),z.propTypes={children:f.a.node,padding:G["c"].spacing,elementRef:f.a.func,as:f.a.elementType,variant:f.a.oneOf(["default","inverse"]),overflow:f.a.oneOf(["scroll","fit"])},z.defaultProps={padding:"medium",as:"div",variant:"default",children:null,elementRef:void 0,overflow:void 0},P))||W)||W)
...
var $=(A=Object(U["a"])(),H=Object(G["j"])(Y,Z),A(Q=H(Q=(K=V=function(e){Object(d["a"])(t,e)
var n=Object(c["a"])(t)
function t(){Object(a["a"])(this,t)
return n.apply(this,arguments)}Object(i["a"])(t,[{key:"render",value:function(){var e
var n=this.props,t=n.children,a=n.variant,i=Object(o["a"])(n,["children","variant"])
var d=(e={},Object(r["a"])(e,Z.root,true),Object(r["a"])(e,Z.inverse,"inverse"===a),e)
return l.a.createElement("div",Object.assign({className:b()(d)},Object(x["b"])(i)),t)}}])
t.displayName="ModalFooter"
return t}(s["Component"]),V.propTypes={children:f.a.node,variant:f.a.oneOf(["default","inverse"])},V.defaultProps={variant:"default",children:null},K))||Q)||Q)
...
var de=(ne=Object(U["a"])(),te=Object(G["j"])(ee,ie),ne(oe=te(oe=(ae=re=function(e){Object(d["a"])(t,e)
var n=Object(c["a"])(t)
function t(e){var o
Object(a["a"])(this,t)
o=n.call(this,e)
...
return Object(g["a"])(e,[J])?Object(O["a"])(e,{variant:t,overflow:e.props.overflow||o}):Object(O["a"])(e,{variant:t})}))}},{key:"renderDialog",value:function(e){var n
var t=this.props,o=t.onDismiss,a=t.label,i=t.shouldCloseOnDocumentClick,d=t.shouldReturnFocus,c=t.liveRegion,s=t.size,u=t.constrain,f=t.as
var p=l.a.createElement(v["a"],Object.assign({},Object(x["b"])(e),{as:f,open:true,label:a,defaultFocusElement:this.defaultFocusElement,shouldCloseOnDocumentClick:i,shouldCloseOnEscape:true,shouldContainFocus:true,shouldReturnFocus:d,liveRegion:c,onDismiss:o,className:b()((n={},Object(r["a"])(n,ie.root,true),Object(r["a"])(n,ie[s],true),Object(r["a"])(n,ie.inverse,"inverse"===this.props.variant),Object(r["a"])(n,ie["overflow--fit"],"fit"===this.props.overflow),Object(r["a"])(n,ie.ie11,this.ie11),n)),ref:this.contentRef}),this.renderChildren())
if("fullscreen"===s){var h
return l.a.createElement("span",{className:b()((h={},Object(r["a"])(h,ie.fullscreenLayout,true),Object(r["a"])(h,ie["fullscreenLayout--".concat(u)],true),h))},p)}return l.a.createElement(w["a"],{placement:this.maskPlacement,fullscreen:"window"===u},p)}},{key:"render",value:function(){var e=this.props,n=e.open,t=e.onOpen,r=e.onClose,a=e.mountNode,i=e.insertAt,d=e.transition,c=e.onEnter,s=e.onEntering,u=e.onEntered,f=e.onExit,p=e.onExiting,b=e.onExited,v=e.constrain,h=(e.overflow,Object(o["a"])(e,["open","onOpen","onClose","mountNode","insertAt","transition","onEnter","onEntering","onEntered","onExit","onExiting","onExited","constrain","overflow"]))
var m=n||this.state.transitioning
return l.a.createElement(_["a"],{mountNode:a,insertAt:i,open:m,onOpen:Object(k["a"])(this.handlePortalOpen,t),onClose:r},m&&l.a.createElement(y["a"],{in:n,transitionOnMount:true,unmountOnExit:true,type:d,onEnter:c,onEntering:s,onEntered:u,onExit:f,onExiting:p,onExited:Object(k["a"])(this.handleTransitionExited,b),theme:this.ie11?{duration:"0s"}:null},"parent"===v?l.a.createElement("span",{className:ie.constrainContext},this.renderDialog(h)):this.renderDialog(h)))}},{key:"defaultFocusElement",get:function(){return this.props.defaultFocusElement}},{key:"DOMNode",get:function(){return this._DOMNode},set:function(e){this._DOMNode=e}},{key:"maskPlacement",get:function(){return j["a"]?"top":"fit"===this.props.overflow?"stretch":"center"}}])
t.displayName="Modal"
return t}(s["Component"]),re.propTypes={label:f.a.string.isRequired,children:h["a"].enforceOrder([T,J,$],[T,J],[J,$],[J]),as:f.a.elementType,size:f.a.oneOf(["auto","small","medium","large","fullscreen"]),variant:f.a.oneOf(["default","inverse"]),open:f.a.bool,defaultFocusElement:f.a.oneOfType([f.a.element,f.a.func]),shouldReturnFocus:f.a.bool,shouldCloseOnDocumentClick:f.a.bool,onOpen:f.a.func,onClose:f.a.func,onDismiss:f.a.func,contentRef:f.a.func,mountNode:f.a.oneOfType([m["a"],f.a.func]),insertAt:f.a.oneOf(["bottom","top"]),liveRegion:f.a.oneOfType([f.a.arrayOf(f.a.element),f.a.element,f.a.func]),transition:y["a"].propTypes.type,onEnter:f.a.func,onEntering:f.a.func,onEntered:f.a.func,onExit:f.a.func,onExiting:f.a.func,onExited:f.a.func,constrain:f.a.oneOf(["window","parent"]),overflow:f.a.oneOf(["scroll","fit"])},re.defaultProps={open:false,size:"auto",variant:"default",transition:"fade",onOpen:function(e){},onClose:function(e){},onDismiss:function(e){},onEnter:function(){},onEntering:function(){},onEntered:function(){},onExit:function(){},onExiting:function(){},onExited:function(){},as:void 0,mountNode:null,insertAt:"bottom",liveRegion:null,contentRef:function(e){},shouldCloseOnDocumentClick:true,shouldReturnFocus:true,defaultFocusElement:null,children:null,constrain:"window",overflow:"scroll"},re.Header=T,re.Body=J,re.Footer=$,ae))||oe)||oe)}}])

//# sourceMappingURL=28-c-d698013fa3.js.map