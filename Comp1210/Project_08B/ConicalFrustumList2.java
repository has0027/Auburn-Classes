...
/**
* Returns the object with least height.
*
* @return least height
*/  
   public double findConicalFrustumWithLeastHeight() {
   
      if (cfNumber <= 0) {
         return 0;
      }
     
      double leastHeight = objectList[0].getHeight();
      int index = 0;
      while (index < cfNumber) {
         if (leastHeight > objectList[index].getHeight()) {
            leastHeight = objectList[index].getHeight();
         }
         index++;  
      } 
...
/**
* Returns the object with greatest height.
*
* @return greatest height
*/    
   public double findConicalFrustumWithGreatestHeight() {
   
      if (cfNumber <= 0) {
         return 0;
      }
     
      double greatestHeight = objectList[0].getHeight();
      int index = 0;
      while (index < cfNumber) {
         if (greatestHeight < objectList[index].getHeight()) {
            greatestHeight = objectList[index].getHeight();
         }
         index++;  
      } 
...
/**
* Returns the object with least volume.
*
* @return least volume
*/   
   public double findConicalFrustumWithLeastVolume() {
   
      if (cfNumber <= 0) {
         return 0;
      }
     
      double leastVolume = objectList[0].volume();
      int index = 0;
      while (index < cfNumber) {
         if (leastVolume < objectList[index].volume()) {
            leastVolume = objectList[index].volume();
         }
         index++;  
      } 
...
/**
* Returns the object with greatest volume.
*
* @return greatest volume
*/   
   public double findConicalFrustumWithGreatestVolume() {
   
      if (cfNumber <= 0) {
         return 0;
      }
     
      double greatestVolume = objectList[0].volume();
      int index = 0;
      while (index < cfNumber) {
         if (greatestVolume < objectList[index].volume()) {
            greatestVolume = objectList[index].volume();
         }
         index++;  
      } 
